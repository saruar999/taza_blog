    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_img', models.ImageField(help_text='Image to be placed at the top of blog post', upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL)),
                ('parent_comment', models.ForeignKey(help_text='Comment object which this comment replied to', null=True, on_delete=django.db.models.deletion.CASCADE, to='core.comments')),
        ...
        migrations.AddField(
            model_name='posts',
            name='post_author',
            field=models.ForeignKey(help_text='The author of post', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='core.author'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='author',
            name='favorite_posts',
            field=models.ManyToManyField(help_text='List of favorited posts', through='core.AuthorFavoritePosts', to='core.posts'),
        ),
    ]
